...
namespace CodeFirstUniversity.Controllers
{
    public class Students2Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstMidName,EnrollmentDate,Activo")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LastName,FirstMidName,EnrollmentDate,Activo")] Student student)
        {
            if (ModelState.IsValid)
            {
